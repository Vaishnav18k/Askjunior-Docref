...
//     );
//     const tagFilter = selectedTag ? doc.workspace_doctags.includes(selectedTag) : true;
...
//           <p className="text-gray-600">Manage and organize your document collection</p>
//         </div>
...
//           <h3 className="font-semibold tracking-tight text-lg">Search & Filter</h3>
//         </div>
...
//               <button
//                 className={`inline-flex items-center gap-1 rounded-md px-3 py-1 text-sm font-medium transition-colors ${
//                   !selectedTag
...
//                       : 'bg-muted text-muted-foreground hover:bg-muted/80'
//                   }`}
//                   onClick={() => setSelectedTag(tags === selectedTag ? null : tags)}
//                 >
//                   <Tag className="h-3 w-3" />
//                   {tags}
//                 </button>
...
//           </h3>
//           <p className="text-sm text-muted-foreground">All your uploaded documents</p>
//         </div>
//         <div className="p-6 pt-0">
...
//                   className="border bg-card p-4 rounded-md hover:shadow-md transition-shadow"
//                 >
//                   <div className="flex items-start justify-between">
//                     <div>
//                       <h4 className="font-semibold">{doc.workspace_doctitle}</h4>
//                       <p className="text-sm text-muted-foreground">
//                         {doc.workspace_doctitle} • {formatFileSize(doc.workspace_filesize)}
//                       </p>
//                       <p className="text-xs text-muted-foreground">
//                         Uploaded {new Date(doc.docuploaded_date).toLocaleDateString()}
//                       </p>
...
//                           <h4 className="font-semibold text-xs">{doc.workspace_notes}</h4>
//                         </div>
//                     </div>
...
const MyFiles: React.FC = () => {
  ...
  const filteredDocuments = documents.filter((doc: any) => {
    ...
    const titleMatch = doc.workspace_doctitle?.toLowerCase().includes(searchLower) ?? false;
    
    const tags = Array.isArray(doc.workspace_doctags) ? doc.workspace_doctags : [];
                ...
                >
                  <div className="flex items-start justify-between">
                    <div>
                      <h4 className="font-semibold">{doc.workspace_doctitle}</h4>
                      <p className="text-sm text-muted-foreground">
                        {doc.workspace_filetype} • {formatFileSize(doc.workspace_filesize)}
                      </p>
                      <p className="text-xs text-muted-foreground">
                        Uploaded {new Date(doc.docuploaded_date).toLocaleDateString()}
                      </p>
